...
export default class Ahfc_acuraLoyaltyAdvantage extends NavigationMixin(LightningElement) {
  ...
  @track mobileSections = [
    {
      id: "0",
      parentClass:
        "slds-accordion__list-item ahfc-accordion-item ahfc-background-lightest",
      ...
      accordionData: [
        {
          id: 0,
          item: "If you drive more than your contracted lease miles, we’ll waive one-half of your excess mileage (up to 7,500)",
          divOrSpan: true
        },
        {
          id: 1,
          item: "2",
          customClass: "ahfc_superScript ahfc_marginRight",
          divOrSpan: true
        },
        {
          id: 2,
          item: "when you lease or finance through Acura Financial Services (AFS).",
          divOrSpan: true
        }
      ]
    },
    {
      ...
      accordionData: [
        {
          id: 0,
          item: "If you have driven fewer than your contracted lease miles, your unused lease miles (up to 15,000 miles)",
          divOrSpan: true
        },
        {
          id: 0,
        ...
        {
          id: 0,
          item: "will be rounded up to the nearest 1,000 and added to your next Acura Luxury Lease.",
          divOrSpan: true
        }
      ]
    },
    {
      ...
      accordionData: [
        {
          id: 0,
          item: " With term choices from 24 to 60 months, you can control how much you pay monthly and how long your lease will run."
        }
      ]
    },
    {
      ...
      accordionData: [
        {
          id: 0,
          item: "Choose from 7,500, 10,000, 12,000 or 15,000 miles per year, and additional miles can be purchased at signing."
        }
      ]
    },
    {
      ...
      accordionData: [
        {
          id: 0,
          item: "Guaranteed Asset Protection (GAP) generally covers the difference between insurance payments and the outstanding lease if your vehicle is stolen or deemed a total loss. GAP coverage is standard on all Acura Luxury Leases."
        }
      ]
    },
    {
      ...
      accordionData: [
        {
          id: 0,
          item: "The Acura Luxury Lease includes a $750 Excessive Wear-and-Use or Damage Waiver."
        }
      ]
    }
  ];
  ...
  @track accObj = [
    {
      ...
      indicatorId: "1",
      indicatorClass:
        "slds-carousel__indicator-action ahfc_corouselButton slds-is-active ahfc_isActive",
      ariaSelected: false,
      panelId: "1",
      name: "first"
    },
  ...
  onMobileSectionsClick(event) {
    ...
    const parentopen =
      "slds-accordion__list-item ahfc-accordion-item ahfc-background-lightest ahfc_parentOpen";
    const parentclose =
      "slds-accordion__list-item ahfc-accordion-item ahfc-background-lightest";
    ...
    if (event.currentTarget.dataset.keyno) {
      this.mobileSections[event.target.dataset.keyno].isOpened =
        !this.mobileSections[event.target.dataset.keyno].isOpened;
  ...
  onFindAlocal() {
    let adobedata = {
      ...
      "Page.brand_name": sessionStorage.getItem("domainBrand")
        ? sessionStorage.getItem("domainBrand")
        : ""
    };
  ...
  onCarousalIndicatorClick(event) {
    ...
    if (event.target.dataset.indicator == 1) {
      this.isFirst = true;
      this.isSecond = false;
      this.accObj[0].indicatorClass =
        "ahfc_isActive slds-carousel__indicator-action ahfc_corouselButton slds-is-active ahfc_isActive";
      this.accObj[1].indicatorClass =
        "slds-carousel__indicator-action ahfc_corouselButton";
    } else {
      this.isFirst = false;
      this.isSecond = true;
      this.accObj[0].indicatorClass =
  ...
  setPageData(prevPage, nextPage) {
    ...
    this.accObj[nextPage].indicatorClass =
      "slds-carousel__indicator-action slds-is-active";
    this.accObj[nextPage].ariaSelected = "true";

    let panelBlock = this.template.querySelector(
      `.ahfc-carousal .slds-carousel__panels`
    );
