({
    doInit: function (component, event, helper) {
        ...
        var salesforceid =  sessionStorage.getItem('salesforce_id');
        ...
        if((userId !=undefined || userId !=null) ){
         ...
         component.get("c.closeModelFA").run();

            helper.financeAccountnumberList(component, event, helper);
        ...
        if (url.includes(hondaDomain)) {
            ...
            vfOrigin = $A.get('$Label.c.AHFC_Honda_URL');
            ...
            vfOrigin = $A.get('$Label.c.AHFC_Acura_URL');
    ...
    //handle FinanctAccount Picklist Selection
    handleOnChangeA : function(component, event, helper) {
          
        var finAcc = component.get("v.strSeletedfinanceId");
         console.log('jai1',finAcc);
           },
            

      saveFinanceAccount : function(component, event) {
           
         
         if(component.get("v.strSeletedfinanceId") !=null && component.get("v.strSeletedfinanceId") !='' )
            {
        		 var strSeletedfinanceId = component.get("v.strSeletedfinanceId"); 
                console.log('jai2',strSeletedfinanceId);
                 sessionStorage.setItem('salesforce_id',component.get("v.strSeletedfinanceId")); 
   ...
   closeModelFA: function (component, event, helper) {
        // for Hide/Close Model,set the "isOpen" attribute to "Fasle"  
        component.set("v.isOpenFA", false);
    },

    openModelFA: function (component, event, helper) {
        // for Display Model,set the "isOpen" attribute to "true"
        component.set("v.isOpenFA", true);
    },
  ...
  /* US 26055 Narain End*/
   ...
   onSelectFinance: function (component, helper) {
       var strFissrstName = component.get('v.FCId');
       console.log('hi'+strFissrstName);
    ...
    redirectToHome: function (component, event, helper) {
        //@KP Nov/08 - T-747962 Cancellation return to MyAccount Page
         ...
         var SCRA_pathName = $A.get("$Label.c.SCRA_F_A_Q_Knowledge_Article_Pathname");
 		 var SCRA_URL = protocol+hostname+SCRA_pathName;
        // Adding custom label for domain [3/01/2019]
        var hondaDomain = $A.get("$Label.c.HONDA_DOMAIN");
