({
    ...
    doInit : function (component, event, helper) {
       ...
       component.set("v.strFaAccountDisp", component.get("v.strFaAccount"));
	    ...
	    component.set("v.strSeletedfinanceIdDisp", component.get("v.strSeletedfinanceId")); //Narain
...
*/        
    ...
    redirectToHome : function(component,event,helper){
       ...
       if (url.includes(hondaDomain)) {
           url= SCRA_URL;
            // url = $A.get("$Label.c.SCRA_Honda_F_Q_Knowledge_Article_URL");
             
       } else {
         
          url= SCRA_URL;
           // url = $A.get("$Label.c.SCRA_Acura_F_Q_Knowledge_Article_URL");
       } 
