({
    ...
    doInit : function (component) {
        ...
        if(strdob2!=null && strdob2!=undefined && strdob2!='')
        {
           var dt=new Date(strdob2);
           const options = {
                month: "short",
                day: "numeric",
                year: "numeric"
          ...
          var dob=dt.toLocaleDateString("en-US", options);
          console.log('dob >>>>> ',dob);
          component.set("v.strdob2Disp",dob);    
        }else{
          component.set("v.strdob2Disp",strdob2);    
        }
